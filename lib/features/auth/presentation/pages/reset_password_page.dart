...
class _ResetPasswordPageState extends State<ResetPasswordPage> {
  ...
  Future<void> _resetPassword() async {
    ...
    if (newPassword != _confirmPasswordController.text) {
      SnackBarUtils.showError(context, context.tr('auth.password_mismatch'));
      return;
    }
    if (_otp.length != 4) {
      SnackBarUtils.showError(context, context.tr('auth.otp_invalid'));
      return;
    }
    ...
    try {
      ...
      if (!mounted) return;
      SnackBarUtils.showSuccess(context, context.tr('reset.success'));
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        _secondsRemaining > 0
                            ? context.tr('reset.resend_in', {
                                's': '$_secondsRemaining',
                              })
                            : context.tr('reset.not_received'),
                        style: TextStyle(
                          color: context.colors.textSecondary,
                          fontSize: 14.sp,
                        ),
                  ...
                  CustomTextField(
                    ...
                    hintText: context.tr('reset.at_least'),
                  ...
                  CustomTextField(
                    ...
                    hintText: context.tr('reset.reenter'),
                    suffixIcon: IconButton(
                      icon: Icon(
                        _obscureConfirm
                            ? Icons.visibility_off_outlined
