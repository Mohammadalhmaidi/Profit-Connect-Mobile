...
class _SignUpPageState extends State<SignUpPage> {
  ...
  void _submit() {
    if (_isLoading) return; // حارس منع الإرسال المكرر
    if (!_formKey.currentState!.validate()) return;
    if (_selectedSkills.length < 3) {
      SnackBarUtils.showFailure(
        context,
        ServerFailure(context.tr('auth.skills_min_3')),
      );
      return;
    }
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _RoleCard(
                          ...
                          label: context.tr('auth.employer'),
                  ...
                  Wrap(
                    ...
                    children: _allSkills.map((skill) {
                      ...
                      return FilterChip(
                        ...
                        selectedColor: AppColors.accentCyan.withValues(
                          alpha: 0.3,
                        ),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Text(
            _label,
            style: TextStyle(color: _color, fontSize: 12.sp),
          ),
        ],
      ),
    );
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16.r),
        border: Border.all(
          color: isSelected ? AppColors.accentCyan : context.colors.inputBorder,
